...
if (! class_exists('osapiEnum')) {
  require 'osapiEnum.php';
}
...
class osapiPerson {
  ...
  public function setLookingFor($lookingFor) {
    $this->setFieldImpl('lookingFor', new osapiEnumLookingFor($lookingFor));
  }
  ...
  public function setNetworkPresence($networkPresence) {
    $this->setFieldImpl('networkPresence', new osapiEnumPresence($networkPresence));
  }
  ...
  public function setSmoker($smoker) {
    $this->setFieldImpl('smoker', new osapiEnumSmoker($smoker));
  }
